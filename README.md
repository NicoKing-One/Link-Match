...
`Link Match 连连看` 是一款移动端竖屏优先的单机 H5 连连看小游戏。当前版本已经从早期三档难度 MVP 演进为三主题、90 关、体力/金币/星级进度、本地存档、二级页面、本地背景音乐、WebAudio 音效和浏览器 smoke 验收闭环的可试玩版本。
...
- 每个主题内 1-10、11-20、21-30 三档关卡当前统一使用 `6列 x 7行` 棋盘；normal/hard 通过图案种类增加和时间递减体现难度。
