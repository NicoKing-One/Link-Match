...
- 当前阶段：`demo1.0.5--首页布局` 已完成，项目从三档难度 demo 升级为章节闯关首页草稿。主游戏页和核心弹框 UI 保持水果糖果果冻风，首页已接入 90 关章节地图、线性解锁、星星记录和金币资源。

## 2. 当前进度

当前已完成 H5 单机 demo 的核心玩法、体力系统、道具占位、结算流程、移动端游戏 UI，以及第一版章节闯关首页布局。最新一轮重点完成了首页关卡地图和关卡进度系统，不再使用旧的“轻松/标准/挑战”三档难度选择作为主入口。
...
- 本轮提交备注：`demo1.0.5--首页布局`。
- 本轮提交内容：章节闯关首页、90 关配置、线性解锁、星星/金币进度、首页 smoke 断言和交接文档更新。
...
1. 继续细化首页地图视觉：关卡点状态、当前关动效、已通关星星表现、锁定主题提示。
2. 开始做个人中心页面：头像昵称占位、当前进度、总星数、金币、已通关数、三星关卡数。
